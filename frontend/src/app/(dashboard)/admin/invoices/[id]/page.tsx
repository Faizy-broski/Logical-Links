...
export default function AdminInvoiceDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!invoice) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4">
        ...
        <Link href="/admin/invoices" className="text-sm text-primary underline">Back to invoices</Link>
      </div>
    );
  }
  ...
  async function handleDuplicate() {
    try { await duplicateMut.mutateAsync(id); toast.success("Invoice duplicated"); router.push("/admin/invoices"); }
        ...
        <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button size="sm" onClick={() => router.push(`/admin/invoices/${id}/edit`)}
            ...
            {invoice.quotations && (
              <div className="overflow-hidden rounded-2xl border border-card-border bg-card shadow-sm">
                ...
                <div className="px-5 py-4">
                  <Link href={`/admin/quotations/${invoice.quotation_id}`}
