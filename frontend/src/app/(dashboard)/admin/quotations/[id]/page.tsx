...
export default function AdminQuotationDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!quotation) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4">
        ...
        <Link href="/admin/quotations" className="text-sm text-primary underline">Back to quotations</Link>
      </div>
    );
  }
  ...
  async function handleDuplicate() {
    try { await duplicateMut.mutateAsync(id); toast.success("Quotation duplicated"); router.push("/admin/quotations"); }
        ...
        <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button size="sm" onClick={() => router.push(`/admin/quotations/${id}/edit`)}
            ...
            <div className="overflow-hidden rounded-2xl border border-card-border bg-card shadow-sm">
              ...
              <div className="space-y-0">
                {[
                  ...
                  { label: "Discount",   value: quotation.discount > 0 ? `− ${new Intl.NumberFormat("en-AU", { style: "currency", currency: "AUD" }).format(quotation.discount)}` : "—", mono: true },
